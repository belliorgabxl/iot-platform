...
const PressButton = ({
  ...
  return (
    ...
    >
      {label == "Up" ? (
        <img src="/png_icon/forwardwhite.png" width={70} height={70} />
      ) : label == "Down" ? (
        <img src="/png_icon/backwhite.png" width={70} height={70} />
      ) : label == "Left" ? (
        <img src="/png_icon/leftwhite.png" width={70} height={70} />
      ) : label == "Right" ? (
        <img src="/png_icon/rightwhite.png" width={70} height={70} />
      ) : label == "Dot" ? (
