  ...
  return (
    <div
      className={`duration-1000  bg-gray-700 ${
        isLoading ? "grid  md:grid-cols-[20%_80%]  lg:grid-cols-[20%_80%] " : "w-full flex "
      }`}
    >
      <div
        className={`transition-opacity lg:block md:block hidden  duration-1000 ${
          isLoading
      ...
      >
        <div className="lg:text-2xl font-semibold bg-gray-900 px-10 py-3  text-white shadow-md shadow-gray-950 my-6 grid place-items-center">
          Side Bar
        </div>
      ...
      <div className=" grid place-items-center px-3  pb-20">
        ...
        <div className="bg-gray-800 w-full lg:px-5 px-3 rounded-2xl grid place-items-center">
          <div className={`my-10 w-full ${isLoading ? 'animate-fadeIn':'opacity-0'}`}>
            <li className="lg:text-3xl text-xl text-white mb-5 font-semibold">Open Source IoT PlatForm</li>
            <div className="bg-gray-950 px-5 py-10  text-white lg:text-2xl">
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-600 px-2 lg:text-2xl font-semibold mr-1">This IoT PlatForm</span>: is designed to
          ...
          <div className={`my-10 w-full lg:px-5 ${isLoading ? 'animate-fadeIn':'opacity-0'}`}>
            <li className="lg:text-3xl text-xl text-white mb-5 font-semibold">Main Features</li>
            <div className="bg-gray-950 px-5 py-10  text-white lg:text-2xl">
              &nbsp;&nbsp;&nbsp;&nbsp;The main features of this web application
              are as follows:
              <br /><br/><br/>
              &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-600 px-2 lg:text-2xl font-semibold mr-1">IoT device connectivity</span>: The web
              ...
              <br /><br/>
              &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-600 px-2 lg:text-2xl font-semibold mr-1">IoT device management</span>: Whether you
              ...
              <br /><br/>
              &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-600 px-2 lg:text-2xl font-semibold mr-1">Real-time control and operation</span>: You
              ...
              <br /><br/>
              &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-600 px-2 lg:text-2xl font-semibold mr-1">Wi-Fi connection cinfiguration</span>: The
          ...
          <div className={`my-10 w-full lg:px-5 ${isLoading ? 'animate-fadeIn':'opacity-0'}`}>
            <li className="lg:text-3xl text-xl text-white mb-5 font-semibold">Devices</li>
            <div className="bg-gray-950 px-5 py-10  text-white lg:text-2xl">
              &nbsp;&nbsp;&nbsp;&nbsp;The devices in this web application are
              categorized into three types:
              <br /><br/><br/>
              &nbsp;&nbsp;&nbsp;&nbsp;1.<span className="text-green-500 bg-gray-800 shadow-inner shadow-gray-950 px-3 py-1 lg:text-2xl font-semibold mx-2">Car</span> A remote-controlled car operated through the web application
              in real-time.
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;2.<span className="text-green-500 bg-gray-800 shadow-inner shadow-gray-950 px-3 py-1 lg:text-2xl font-semibold mx-2 ">Robotic Arm</span> A robotic arm that can be
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;3.<span className="text-green-500 bg-gray-800 shadow-inner shadow-gray-950 px-3 py-1 lg:text-2xl font-semibold mx-2 ">Smart Plane Pot</span> A plant pot
          ...
          <div className={`my-10 w-full lg:px-5 ${isLoading ? 'animate-fadeIn':'opacity-0'}`}>
            <li className="lg:text-3xl text-xl text-white mb-5 font-semibold">Step 1 Adding your device
            </li>
            <div className="bg-gray-950 px-5 py-10  text-white lg:text-2xl">
            To operate devices through the web application, you must know the <br/><br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-600 px-2 lg:text-2xl font-semibold mr-1">Serial ID </span>: of the device. The Serial ID is required when adding a new device via the "Add Device" page.
              <br/><br/>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-600 px-2 lg:text-2xl font-semibold mr-1">Key Points about the Serial ID</span>
          ...
          <div className={`my-10 w-full lg:px-5 ${isLoading ? 'animate-fadeIn':'opacity-0'}`}>
            <li className="lg:text-3xl text-xl text-white mb-5 font-semibold">Topic</li>
            <div className="bg-gray-950 px-5 py-10  text-white lg:text-2xl">
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-600 px-2 lg:text-2xl font-semibold mr-1">Start with </span>:
            </div>
          </div>
          <div className={`my-10 w-full lg:px-5 ${isLoading ? 'animate-fadeIn':'opacity-0'}`}>
            <li className="lg:text-3xl text-xl text-white mb-5 font-semibold">Topic</li>
