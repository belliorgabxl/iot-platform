  ...
  return (
    <div className={`grid grid-rows-2 w-full ${isLoading ? "" : ""}  `}>
      <div className="grid grid-cols-[50%_50%] gap-2 mb-2">
        ...
        >
          <button
            className={`duration-75 bg-gray-800 rounded-full px-8 shadow-md shadow-gray-900 py-2 mx-5 active:bg-violet-700 ${
        ...
        <div
          className={`duration-1000 grid place-items-center shadow-md shadow-gray-900  rounded-full ${
            isLoading ? "bg-blue-800" : "bg-gray-500"
          } `}
        >
          {hold == false ? (
            <button
              className={`active:shadow-inner active:shadow-black text-4xl duration-75 bg-gray-800 active:bg-violet-700  shadow-md shadow-gray-900 text-white  rounded-full py-8 px-2 ${
                isLoading ? "animate-fadeIn" : "opacity-0"
              } `}
              onClick={Hold}
            >
            ...
            <button
              className={`active:shadow-inner active:shadow-black text-4xl duration-75 bg-green-600 active:bg-violet-700  shadow-md shadow-gray-900 text-white  rounded-full py-8 px-2 ${
                isLoading ? "animate-fadeIn" : "opacity-0"
              } `}
              onClick={Hold}
            >
      ...
      <div
        className={`duration-1000 text-2xl shadow-md shadow-gray-900 text-white w-full rounded-lg py-5 px-5 grid place-items-center ${
          isLoading ? " bg-blue-800" : "bg-gray-500"
        }  `}
      >
        <button
          className={`duration-500 bg-gray-800 rounded-full px-8 shadow-md shadow-gray-900 py-2 mx-5 active:bg-violet-700 ${
            isLoading ? "animate-fadeIn" : "opacity-0"
          } `}
          onClick={Forward}
        >
